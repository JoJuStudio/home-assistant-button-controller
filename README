...
[![GitHub Release](https://img.shields.io/github/release/[yourusername]/home-assistant-button-controller.svg)](https://github.com/[yourusername]/home-assistant-button-controller/releases)
